...
" relative line is normal; absolute lines in insert mode
...
set wildoptions=pum         " Completion opitons displayed vertically (popup menu)
...
set clipboard+=unnamed,unnamedplus      " Enable system clipboard integration
...
" open nerd tree in split tree view
...
" navigate easily between tmux panes and vim
